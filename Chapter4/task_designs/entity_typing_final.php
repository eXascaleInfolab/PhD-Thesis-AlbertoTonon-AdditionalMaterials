...
if( isset($_GET['docID']) ) {
	...
	if( startsWith($docID, 'P-') ) $dir = 'paragraphs';
	else if ( startsWith($docID, 'S-') ) $dir = 'sentences';
	else if( startsWith($docID, 'P3-') ) $dir = 'paragraphs_context'; 
	else $dir = 'JSON';

	$json = file_get_contents("$dir/$docID.json", FILE_TEXT);
